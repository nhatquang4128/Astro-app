  ...
  return (
    <Box gap="$2">
      <HStack justifyContent="space-between">
        <RatingStar rate={1} size={16} />
        <RatingStar rate={2} size={16} />
        <RatingStar rate={3} size={16} />
      </HStack>
      <Progress value={100} size="sm">
        <ProgressFilledTrack bg="$primary300" />
      </Progress>
      <HStack justifyContent="space-between" marginTop={-18}>
        <VStack alignItems="center" gap="$2" opacity={0}>
          <Box height={12} width={2} bg="$primary600" />
          <HStack gap="$1">
            <Timer1 size="16" color={colors.coolGray500} />
